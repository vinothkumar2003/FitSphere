...
const menuItems = [
  { label: "Dashboard", to: "/trainer", icon: (
  ...
  { label: "Gym Plans", to: "/trainer/gymplans", icon: (
  ...
  { label: "Users", to: "/trainer/users", icon: (
  ...
  { label: "Diet food", to: "/trainer/dietfoot", icon: (
  ...
  { label: "Work done", to: "/trainer/workdone", icon: (
  ...
  { label: "Gym equipment ", to: "/trainer/gym-equipment", icon: (
  ...
  { label: "Settings", to: "/trainer/settings", icon: (
          ...
          <>
            ...
            {profileDropdownOpen && (
              <ul className="profile-dropdown">
                <li><Link to="/trainer/settings">Settings</Link></li>
