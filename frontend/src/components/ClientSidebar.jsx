...
const menuItems = [
  ...
  { label: "Gym Plans", to: "/client/gymplans", icon: (
  ...
  { label: "My Booking", to: "/client/bookings", icon: (
   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="none"><path d="M16 7.5a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0M13.5 18a4.5 4.5 0 1 0 9 0a4.5 4.5 0 0 0-9 0"/><path stroke="currentColor" stroke-linecap="square" stroke-width="2" d="M10 15H8a5 5 0 0 0-5 5v1h7.05M16 7.5a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0Zm2 9.252V18l1 1m-1 3.5a4.5 4.5 0 1 1 0-9a4.5 4.5 0 0 1 0 9Z"/></g></svg>
  ) },
  { label: "Diet food", to: "/client/dietfoot", icon: (
  ...
  { label: "Gym equipment ", to: "/client/gym-equipment", icon: (
  ...
  { label: "Profile", to: "/client/profile", icon: (
      ...
      <div id="sidebar" className={sidebarOpen ? "" : "close"}>
        <ul>
          <li>
            ...
            <button
              id="toggle-btn"
              onClick={() => {setSidebarOpen((open) => !open); setProfileDropdownOpen(false); }}
            ...
            <>
              ...
              {profileDropdownOpen && (
                <ul className="profile-dropdown">
                  {/* <li><Link to="/gymplans/create">New Gym Plan</Link></li> */}
            ...
            <>
              ...
              {profileDropdownOpen && (
                <ul className="profile-dropdown closed">
                  {/* <li><Link to="/client/gymplans/create">New Gym Plan</Link></li> */}
                  <li><Link to="/client/settings">Settings</Link></li>
                  <li><Link to="/client/profile">Profile</Link></li>
                  <li><button style={{ background: "none", border: "none", color: "#333", width: "100%", textAlign: "left", cursor: "pointer" }} onClick={handleSignOut}>Sign out</button></li>
                </ul>
